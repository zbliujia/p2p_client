...
class DeviceSelectPage extends BaseStatefulWidget {
  final Object? arguments;
  final List<DeviceInfo> devices;

  DeviceSelectPage({Key? key, required this.devices, this.arguments})
      : super(key: key);

  @override
  State createState() => _DeviceSelectPageState();
}

class _DeviceSelectPageState extends BaseState<DeviceSelectPage> {

  void selectDevice(DeviceInfo device) async {
    await ServerApi.setDefaultDevice(device.id!);
  }
                ...
                child: Container(
                  ...
                  child: Row(
                    children: [
                      ...
                      TextButton(
                        child: Text("选择设备", style: TextStyle(
