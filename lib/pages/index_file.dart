...
class IndexFilePage extends BaseStatefulWidget {
  final Object? arguments;

  IndexFilePage({Key? key, this.arguments}) : super(key: key);

  @override
  State createState() => _IndexFilePageState();
}

class _IndexFilePageState extends BaseState<IndexFilePage> {
  @override
